...
$(document).ready(function () {
    ...
    gsap.from(".js-nav", {
        duration: 0.3, y: '-200px',

    })
    gsap.from(".js-banner-height", {
        duration: 0.8, delay: 0.4, opacity: 0, x: 100,
        scrollTrigger: {
            trigger: ".js-banner",
        }
    })
    ...
    banner.from(".js-banner-title", { opacity: 0, x: '-100px', duration: 0.8, delay: 0.4 })

        .from(".js-banner-text", { opacity: 0, x: '-100px', duration: 0.8 }, '-=0.4')
        .from(".js-banner-link", { opacity: 0, x: '-100px', duration: 0.8 }, '-=0.4')



    gsap.from(".js-firstSection-imgBox", {
        duration: 0.8, opacity: 0, x: -100,
        scrollTrigger: {
    ...
    sectionThird.from(".js-sectionThird-title", { opacity: 0, y: '300px', duration: 0.4, })
        .from(".js-sectionThird-subtitle", { opacity: 0, y: '300px', duration: 0.4 }, '-=0.2')
    ...
    sectionFouth.from(".js-sectionFouth", { opacity: 0, y: '300px', duration: 0.8, })
        .from(".js-sectionFouth-text", { opacity: 0, y: '300px', duration: 0.8 }, '-=0.2')
    ...
    sectionFouth.from(".js-sectionFifth-list1", { opacity: 0, y: '300px', duration: 0.8, })
        .from(".js-sectionFifth-list2", { opacity: 0, y: '300px', duration: 0.8 }, '-=0.2')
        .from(".js-sectionFifth-list3", { opacity: 0, y: '300px', duration: 0.8 }, '-=0.2')
        .from(".js-footer", { opacity: 0, y: '300px', duration: 0.8 }, '-=0.2')
